...
There are many existing plugins you can study; you might start with the [Example Plugins](https://github.com/nfarina/homebridge/tree/master/example-plugins). This contains a single plugin that registers a platform that offers fake light accessories. This is a good example for using the Homebridge Plugin API. You can also find an example plugin that [publishes an individual accessory](https://github.com/nfarina/homebridge/tree/6500912f54a70ff479e63e2b72760ab589fa558a/example-plugins/homebridge-lockitron).
